...
#         if agent_with_memory is None:
#             chat_history.append(
#                 {"role": "system", "content": "Please upload a CV first."}
#             )
#             print("Chat history no agent:", chat_history)
#             return "", chat_history
#         try:
#             updated_history = chat_with_agent(
#                 message,
#                 chat_history,
#                 "1234",
#                 agent_with_memory,
...
#     agent_state, _ = init_agent(
#         "/Users/elena/Documents/private/job_application/CV.pdf"
#     )
...
# while True:
#     msg = input(
#         "Ask me anything!\n" if len(chat_history) == 0 else f"{mpodel_response}\n"
#     )
#     ehm, updated_history = respond(msg, chat_history, agent_state)
#     mpodel_response = updated_history[-1]["content"]
